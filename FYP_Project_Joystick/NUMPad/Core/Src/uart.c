...
void USART_Init(void)
{
	...
	/* USART2 is on APB1 = 42 MHz (SYSCLK 84 MHz / 2), oversampling 16.
	 * USARTDIV = 42e6 / (16 * 115200) = 22.786 -> mantissa 22, fraction 13. */
	USART2->BRR = (22 << 4) | (13);				// FCLK = 42MHz and BaudRate = 115200
